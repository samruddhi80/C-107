...
def drawBox(img,bbox):
    #write code for this function here
     ...
     cv2.putText("Tracking",img,(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,255,0),2)
...
while True:
   #Write the code inside loop here
    ...
    success, bbow=tracker.update(img)
    if success:
           drawBox(img,bbox)

    else:
            cv2.putText("Lost",img,(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,255,0),2)
